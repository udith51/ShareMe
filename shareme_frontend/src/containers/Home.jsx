...
export default function Home() {
    ...
    // Obtain id from localStorage but get complete details of user from Sanity using this id
    useEffect(() => {
    ...
    return (
        <div className="flex bg-gray-50 md:flex-row flex-col h-screen transition-height duration-75 ease-out">
            ...
            {/* Large Screen sidebar close */}

            {/* Small Screen sidebar open */}
